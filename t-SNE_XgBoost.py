...
output_dir = '/Users/leopard/Desktop/NIBM/ml2/Sign-Language/Output/t-SNE/Model1'
...
# Train the model
eval_set = [(X_train_smote, y_train_smote_reindexed), (X_test_tsne, y_test_reindexed)]
xgb_model.fit(
...
# Make predictions
y_pred_proba = xgb_model.predict_proba(X_test_tsne)
y_pred = xgb_model.predict(X_test_tsne)
